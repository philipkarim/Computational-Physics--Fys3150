...
def main():
    v10 = readFile("generelFilPlot1");
    v100 = readFile("generelFilPlot2");
    v1000 = readFile("generelFilPlot3");
    ...
    ppl.xlabel("x")
    ppl.ylabel("v''(x)")
    ppl.savefig("GenerelPlot")
    ppl.title("Nummerisk losning av andregrads differentiallikning med ulike n-verdier ")
